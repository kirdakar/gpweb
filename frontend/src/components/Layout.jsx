    ...
    items: [
      ...
      { to: '/users', label: 'युजर मास्टर', adminOnly: true },
      {
        ...
        submenu: [
          ...
          { to: '/gp1to33/stock-items', label: 'उपभोग्य वस्तू मास्टर (नमुना १५)', screen: 'stock_items' },
          { to: '/gp1to33/contractors', label: 'कंत्राटदार मास्टर (नमुना २०ख)', screen: 'contractors' },
          { to: '/gp1to33/rate-schedule', label: 'दरसूची मास्टर (नमुना २०)', screen: 'rate_schedule' },
        ],
      },
    ],
  },
    ...
    items: [
      ...
      { to: '/payments', label: 'कर जमा भरणे', screen: 'payments' },
      {
        ...
        submenu: [
          ...
          { to: '/gp1to33/misc-demands', label: 'किरकोळ मागणी नोंदणी (नमुना ११)', screen: 'misc_demands' },
          { to: '/gp1to33/stamps', label: 'मुद्रांक हिशोब नोंदणी (नमुना १४)', screen: 'stamps' },
          { to: '/gp1to33/stock', label: 'उपभोग्य वस्तू साठा नोंदणी (नमुना १५)', screen: 'stock_register' },
          { to: '/gp1to33/fixed-assets', label: 'मालमत्ता नोंदणी (नमुना १६/२२/२३/२४)', screen: 'fixed_assets' },
          { to: '/gp1to33/advance-deposits', label: 'अग्रिम/अनामत नोंदणी (नमुना १७)', screen: 'advance_deposits' },
          { to: '/gp1to33/muster-rolls', label: 'हजेरीपट नोंदणी (नमुना १९)', screen: 'muster_rolls' },
          { to: '/gp1to33/works', label: 'बांधकाम नोंदणी (नमुना २०/२०क/२०ख)', screen: 'works' },
          { to: '/gp1to33/staff-salary', label: 'मासिक वेतन देयक नोंदणी (नमुना २१)', screen: 'staff_salary_bills' },
          { to: '/gp1to33/investments', label: 'गुंतवणूक नोंदणी (नमुना २५)', screen: 'investments' },
          { to: '/gp1to33/balance-statements', label: 'मासिक शिल्लक विवरण नोंदणी (नमुना २६-ख)', screen: 'balance_statements' },
          { to: '/gp1to33/loans', label: 'कर्ज नोंदणी (नमुना २९)', screen: 'loans' },
          { to: '/gp1to33/audit-reports', label: 'लेखापरीक्षण आक्षेप नोंदणी (नमुना ३०)', screen: 'audit_reports' },
          { to: '/gp1to33/travel-bills', label: 'प्रवास भत्ता देयक नोंदणी (नमुना ३१)', screen: 'travel_bills' },
          { to: '/gp1to33/trees', label: 'वृक्ष नोंदणी (नमुना ३३)', screen: 'trees' },
        ],
      },
    ],
  },
